...
<div id="sc-install-notice" class="updated">
	<p>
		...
		<a href="<?php echo esc_url( add_query_arg( 'page', $this->plugin_slug, admin_url( 'admin.php' ) ) ); ?>" class="button-primary"><?php _e( 'Get started by entering your Stripe keys', 'sc' ); ?></a>
